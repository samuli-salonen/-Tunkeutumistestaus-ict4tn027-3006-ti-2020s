...
Tässä tehtävässä piti murtaa 5 hash:ia hashcat:llä. Murrot tein kali linux:lla. 
...
Sitten ruetaan etsimään oikeita parametreja hashcat murtoa varten. Etsimme sopivan referenssi ID:n tiivisteelle komennolla: ```hashcat -h | grep md5```. Greppaamme "md5" sanan sisältävät hohdat helpistä:
