...
Esimerkkinä päätin tunkeutua sisäverkossa olevaan telnet palvelimeen käyttäen metasploittia. Riskien välttämiseksi otin koneeni pois ulkoverkosta kokonaan ja aloitin kokeilemalla, että telnet palvelinkone vastaa pingiin kalista.

![Pingi telnettiin](https://github.com/samuli-salonen/-Tunkeutumistestaus-ict4tn027-3006-ti-2020s/blob/main/Ping.png)
...
A2 tehtävässä käytin ZAP-proxyä, jolla pystyin ujuttamaan omaa syötettä POST-komentoon.
