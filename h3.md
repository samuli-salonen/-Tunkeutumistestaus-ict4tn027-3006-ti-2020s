...
Porttiskannaukset myös tallentivat ``` pingi.xml, pingi.nmap, pingi.gnmap ``` Sama homma myös 10.10.10.198 osoitteesta. Näitä tiedostoja hakkeri pystyy tehokkaasti hyödyntämään jo valmiiksi ajettua skannausta, eikä lisää meteliä tarvitse aiheuttaa.
