...
Tämä tehtävä kuumotteli hemmetisti, mutta tein komennon niinkuin tero oli näyttänyt, eli tein komennon ``` sudo nmap -sn 10.10.14.1-254 -oA pingsweep  ```. Komennossa piti muuttaa IP oman IP avaruuden mukaan.

Tulokseksi tulee seuraavaa:

![pshtb](https://raw.githubusercontent.com/samuli-salonen/-Tunkeutumistestaus-ict4tn027-3006-ti-2020s/main/h3/pshtb.png)
