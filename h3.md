...
```
Saadaan pelkällä nmap-komennolla vähemmän dataa tai jopa virheen. sudo:lla saadaan tässä tapauksessa myös kohteen MAC-osoite.
...
Erot ovat tulosteen määrä ja sen antama data -A antaa esimerkiksi hop:t.
...
Tuloksissa näkyy Wireshark:n tulokset ja komentokehotteen nmap tulokset. Wiresharkissa nähdään kuinka nmap kokeilee 100 suosituinta porttia skannauksessa. Näemme myös kuinka Nmap kokeilee webbi-palvelinta.
...
Tämä tehtävä kuumotteli hemmetisti, mutta tein komennon niinkuin tero oli näyttänyt, eli tein komennon ``` sudo nmap -sn 10.10.10.1-254 -oA pingsweep  ```. Komennossa piti olla todella tarkkana.
...
kokeilin, että liikennettä menee wiresharkin kautta tun0:ssa varmasti ja menikin + sekä 10.10.10.199 antaa kirjautumissivun yhden HTB:n koneen sivulle.
...
WireShark näyttää porttikyselyn liikenteen verkkoadapteri tun0:ssa.

Seuraava porttiskannaus, joka kuumotti kanssa:

![ping2](https://raw.githubusercontent.com/samuli-salonen/-Tunkeutumistestaus-ict4tn027-3006-ti-2020s/main/h3/pingi2.png)

Porttiskannaukset myös tallentivat ``` pingi.xml, pingi.nmap, pingi.gnmap ``` Sama homma myös 10.10.10.198 osoitteesta.
