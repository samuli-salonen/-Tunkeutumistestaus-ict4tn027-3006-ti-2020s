...
Udp porttiskannauksella voisi löytää mahdollisesti DNS- tai pelipalvelimia, koska UDP protocolla on suotuisampi jatkuvan pakettien syötön ja alhaisen latenssin takia. Myös mahdollisia VoIP-palvelimia voidaan löytää UDP-porttiskannauksella. TCP on näennäisesti turvallisempi protokolla.
