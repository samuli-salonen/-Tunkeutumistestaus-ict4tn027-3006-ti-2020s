...
Kokeilin vielä löytää Microsoft IIS:n soveltuvia haavoittuvuuksia string search metodilla, mutta en löytänyt äkkisältään, kuin tämän yhden mahdollisesti sopivan. (```-S``` lippu)
