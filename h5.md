...
Sitten Nmap komento, joka on tässä tapauksessa ```sudo nmap -p1-65535 -A 192.168.56.101 -oA metasploitable2```, joka skannaa kaikki TCP portit ja ajaa scriptiengine:llä version tarkastuksen, hopit, banner crabbingit, yms. 
