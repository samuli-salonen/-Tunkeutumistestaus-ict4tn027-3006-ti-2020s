...
Eyewitness ajo varmistaa sivulla olevan json parserin, sekä antaa muuta hyödyllistä dataa luettavaksi. Wiresharkki näyttää kuinka eyewitness hakee palvelimelta HTTP protocol:lla esimerkiksi palvelimen kuvia.
...
Kyseessä näyttäisi olevan jonkinlainen terveydenalanpalvelin, siis palvelimella voisi olla arkaluontoisia potilastietoja. Kiinnostavaa hakkerin kannalta.
