...
4:s Kone on worker, jonka ip on ```10.10.10.203```. Sama tiedustelu prosedyyri kuin aiemmissakin.
...
Viides kone tässä tehtävässä on Crossfit. Koneen ip HTB:n verkossa on ```10.10.10.208```. Sama nmap kuin ekoissa testauksissa ja eyewitness myös.
