...
Passagen ip osoite on ```10.10.10.206``` ja tässä tapauksessa kokeilin samaa nmap komentoa kuin Time koneen kanssa, mutta vaihdoin ip oikeaksi. Eli komento oli: ``` sudo nmap -A 10.10.10.206 -oA 206 ```. 
