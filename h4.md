...
Toisessa kuvassa näemme piilotettuja tiedostoja, mistä hakkeri voisi päätellä salasanoja ja serverin rakennetta ja ujuttaa omaa koodiaan tiedostoihin. Tässä esemerkissä voimme enimmäkseen nähdä .bashrc tiedostoja, mihin voisi upottaa koodia ja se ajetaan kun käyttäjä kirjautuu sisään.

![lin5](https://github.com/samuli-salonen/-Tunkeutumistestaus-ict4tn027-3006-ti-2020s/blob/main/h4/tulos3.png)

Kolmannessa kuvassa voimme nähdä config-tiedostoja, missä on suoraan salasanoja palvelimelle. Itse saattaisin lähteä tästä selvittelemään, mitä löytyy palvelimelta. Linpeas näyttää myös tiedostojen sijainnin kohdekoneella, missä scripti on ajettu.
